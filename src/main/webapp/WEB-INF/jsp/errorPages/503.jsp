...
<head>
	...
	<title>Martiply 503 - Service Unavailable</title>
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/assets/css/error-pages/style.css" />
	<link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">
	<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.4/jquery.min.js"></script> 
	<script type="text/javascript" src="${pageContext.request.contextPath}/assets/js/wordsearch/wordsearch-resize.js"></script>
...
<div id="wrap">
	...
	<div id="main-content">
		...
		<p>We should resolve this problem shortly - so try reloading this page.</p>
	</div>
